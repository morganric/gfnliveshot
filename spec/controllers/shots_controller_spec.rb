...
describe ShotsController do
  ...
  describe "GET show" do
    it "assigns the requested shot as @shot" do
      shot = Shot.create! valid_attributes
      get :show, {:id => shot.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested shot as @shot" do
      shot = Shot.create! valid_attributes
      get :edit, {:id => shot.to_param}, valid_session
      assigns(:shot).should eq(shot)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Shot" do
        expect {
          post :create, {:shot => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shot as @shot" do
        ...
        post :create, {:shot => { "location" => "invalid value" }}, valid_session
        assigns(:shot).should be_a_new(Shot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shot" do
        ...
        Shot.any_instance.should_receive(:update_attributes).with({ "location" => "MyString" })
        put :update, {:id => shot.to_param, :shot => { "location" => "MyString" }}, valid_session
      end

      it "assigns the requested shot as @shot" do
        shot = Shot.create! valid_attributes
        put :update, {:id => shot.to_param, :shot => valid_attributes}, valid_session
        assigns(:shot).should eq(shot)
      end
    ...
    describe "with invalid params" do
      it "assigns the shot as @shot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shot.any_instance.stub(:save).and_return(false)
        put :update, {:id => shot.to_param, :shot => { "location" => "invalid value" }}, valid_session
        assigns(:shot).should eq(shot)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested shot" do
      shot = Shot.create! valid_attributes
      expect {
        delete :destroy, {:id => shot.to_param}, valid_session
      }.to change(Shot, :count).by(-1)
    end
