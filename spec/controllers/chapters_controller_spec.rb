  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chapter as @chapter" do
        ...
        post :create, {:chapter => { "location" => "invalid value" }}, valid_session
        assigns(:chapter).should be_a_new(Chapter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chapter" do
        ...
        Chapter.any_instance.should_receive(:update_attributes).with({ "location" => "MyString" })
        put :update, {:id => chapter.to_param, :chapter => { "location" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the chapter as @chapter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chapter.any_instance.stub(:save).and_return(false)
        put :update, {:id => chapter.to_param, :chapter => { "location" => "invalid value" }}, valid_session
        assigns(:chapter).should eq(chapter)
      end
